...
export function StatsView() {
  ...
  return (
    ...
    >
      ...
      {history.length === 0 ? (
        <div className="glass-panel rounded-[var(--radius-xl)] p-10 border-white/5 text-center space-y-6">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="glass-panel rounded-[var(--radius-lg)] p-5 border-white/5 text-center space-y-2">
          ...
          <div className="space-y-3">
            ...
            {history.slice(0, 5).map((entry) => (
              <div key={entry.id} className="glass-panel rounded-[var(--radius-lg)] p-5 border-white/5 flex items-center justify-between gap-4">
